...
urlpatterns = [
    ...
    path('admin-view-student-coding-marks', views.admin_view_student_coding_marks_view,name='admin-view-student-coding-marks'),
    path('admin-view-marks/<int:pk>', views.admin_view_marks_view,name='admin-view-marks'),
    path('admin-view-coding-marks/<int:pk>', views.admin_view_coding_marks_view,name='admin-view-coding-marks'),
    path('admin-check-marks/<int:pk>', views.admin_check_marks_view,name='admin-check-marks'),
    path('admin-check-coding-marks/<int:pk>', views.admin_check_coding_marks_view,name='admin-check-coding-marks'),
    ...
    path('delete-coding-course/<int:pk>', views.delete_coding_course_view,name='delete-coding-course'),
    ...
    path('delete-coding-question/<int:pk>', views.delete_coding_question_view,name='delete-coding-question'),

    path('admin-add-coding-course', views.admin_add_coding_course_view,name='admin-add-coding-course'),
    path('admin-view-coding-course', views.admin_view_coding_course_view,name='admin-view-coding-course'),
    path('admin-add-coding-question', views.admin_add_coding_question_view,name='admin-add-coding-question'),
    path('admin-view-coding-question', views.admin_view_coding_question_view,name='admin-view-coding-question'),
    path('view-coding-question/<int:pk>', views.view_coding_question_view,name='view-coding-question'),
